...
political_party.add_argument('name', type=str,
                             help='Please enter your name', required=True)
political_party.add_argument('headquateraddress', type=str,
                             help='Please enter your headquateraddress',
                             required=True)
political_party.add_argument('logo', type=werkzeug.datastructures.FileStorage,
...
class Party(Resource):
    def get(self):
        ...
        if not partys.get_all_party():
            return {"status": 404,
                    "message":
                    "There are no parties available at the moment"}, 404
...
class SingleParty(Resource):
    ...
    def get(self, party_id):
        ...
        return {"status": 200,
                "message": single_party.get_single_party(party_id)}, 200
